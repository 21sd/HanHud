...
CoreGui:SetCore("SendNotification", {
    Title = "寒的欢迎",
    Text = "欢迎"..game.Players.LocalPlayer.Name.."执行寒中心",
    Duration = 5,
})

print("寒脚本滴反挂机已经为你开好了")
...
local getParent = game.Players.LocalPlayer:FindFirstChildOfClass("PlayerGui") or game.Players.LocalPlayer:WaitForChild("PlayerGui")
...
local function HeartbeatUpdate()
    ...
    FpsLabel.Text = ("小寒时间="..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
...
local Window = OrionLib:MakeWindow({IntroText = "感谢"..game.Players.LocalPlayer.Name.."加载GUI",Name = "寒脚本-NEO.UI-1.2.8", HidePremium = false, SaveConfig = true, ConfigFolder = "本人缝合了冬凌中心 在这里致谢    本人QQ号2368406374   帮助者QQ号3852643841"})
...
local Tab = Window:MakeTab({	Name = "₪公告/新的脚本在下面",	Icon = "rbxassetid://7044226690",	PremiumOnly = false})
Tab:AddButton({
	Name = "缝合！裙号",
	Callback = function()
	setclipboard("1053476093")
...
Tab:AddParagraph("我是个缝合王🤑")
Tab:AddParagraph("帮助者 秘境铁子")
Tab:AddParagraph("按理来说秘境铁子什么都没帮🤔")
Tab:AddParagraph("我有什么缺失的，求大佬直点 本人QQ号:2368406374")
Tab:AddButton({
	Name = "小寒ovo",
	Callback = function()
end
...
Tab:AddParagraph("99夜推荐用")
Tab:AddButton({
  Name = "日月xyz(免费版)
  Callback = function ()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Moxiaobai-Shine-Star/Free/refs/heads/main/Loader.lua"))()
  end
})