...
local TabHandles = {
    Main = Tabs.Main:Tab({ Title = "玩家功能", Icon = "user" }),
    Visual = Tabs.Visual:Tab({ Title = "透视功能", Icon = "eye" }),
    Settings = Tabs.Settings:Tab({ Title = "UI设置", Icon = "settings" }),
}
...
local WalkSpeedSlider = TabHandles.Main:Slider({
     Title = "人物速度",
     Desc = "调节角色移动速度",
     Value = {
         Min = 16.0,
...
local JumpPowerSlider = TabHandles.Main:Slider({
     Title = "人物跳跃力",
     Desc = "调节角色跳跃高度",
     Value = {
         Min = 0.0,
...
local NightVisionToggle = TabHandles.Main:Toggle({
    Title = "夜视功能", 
    Desc = "在黑暗中看清环境",
    Value = false, 
    Callback = function(Value)
...
local NightVisionSlider = TabHandles.Main:Slider({
    Title = "夜视亮度",
    Desc = "调节夜视效果的亮度",
    Value = {
        Min = 1.0,
...
local Toggle = TabHandles.Main:Toggle({
    Title = "环境光开关", 
    Desc = "开启/关闭环境光照",
    Value = false, 
    Callback = function(Value)
...
local HanESPToggle = TabHandles.Visual:Toggle({
    Title = "寒透视", 
    Desc = "开启/关闭玩家透视功能",
    Value = false, 
    Callback = function(Value)
...
local themeDropdown = TabHandles.Settings:Dropdown({
    Title = "主题选择",
    Values = themes,
    Value = "Light",
...
local transparencySlider = TabHandles.Settings:Slider({
    Title = "透明度",
    Value = { 
        Min = 0,
        Max = 1,
...
local DarkThemeToggle = TabHandles.Settings:Toggle({
    Title = "启用黑色主题",
    Desc = "使用黑色调主题方案",
    Value = false,
