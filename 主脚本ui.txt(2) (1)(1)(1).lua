...
local Tabs = {
    Basic = Window:Tab({ Title = "不知道", Icon = "zap" }),
...
Tabs.Common:Button({
    Title = "无敌少侠r6",
    Callback = function()
        loadstring(game:HttpGet("loadstring(game:HttpGet("https://raw.githubusercontent.com/ke9460394-dot/ugik/refs/heads/main/%E6%97%A0%E6%95%8C%E5%B0%91%E4%BE%A0%E9%A3%9E%E8%A1%8Cr6.txt"))()"))()
        WindUI:Notify({
            Title = "准备好成为成都超人了吗",
            Content = "成都超人功能已加载",
            Duration = 2
...
Tabs.Common:Button({
    Title = "超级环绕零件v1",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/BS58dL/BS/refs/heads/main/Ring Parts.txt"))()
        WindUI:Notify({
            Title = "正在加载",
            Content = "超级环绕零件v1功能已加载",
            Duration = 2
        })
    end
})
